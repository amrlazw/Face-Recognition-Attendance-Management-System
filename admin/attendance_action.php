...
if(isset($_POST["action"]))
{
	if($_POST["action"] == "fetch")
	{
		...
		foreach($result as $row)
		{
			...
			{
				$status = '<label class="badge badge-success">Manual Attendance</label>';
			}


			if($row["attendance_status"] == "FR-Present")
			{
				$status = '<label class="badge badge-warning">Face Recognition Attendance </label>';
			}
