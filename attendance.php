  ...
  <div class="card">
      ...
      <div class="row">
        ...
        <div class="col-sm-3" align="right">
          <button type="button" id="report_button" class="btn btn-danger btn-sm">Report Generation</button>
</div>
          <div class="col-md-11" align="center">
            <button type="button" id="recognition" class="btn btn-primary btn-xs">Face Recognition</button>


          <button type="button" id="add_button" class="btn btn-info btn-xs">Manual Attendance</button>
